...
public class Enemy3 extends GameObject
{
    ...
    public Enemy3(int x, int y, ID id, Handler handler, SpriteSheet ss)
    {
        super(x, y, id, ss);
        this.handler = handler;

        enemy_image[0] = ss.grabImage(8, 2, 32, 32);
        enemy_image[1] = ss.grabImage(9, 2, 32, 32);
        enemy_image[2] = ss.grabImage(10, 2, 32, 32);
