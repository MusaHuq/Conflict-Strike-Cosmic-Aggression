...
public class Enemy2 extends GameObject
{
    ...
    public Enemy2(int x, int y, ID id, Handler handler, SpriteSheet ss)
    {
        super(x, y, id, ss);
        this.handler = handler;

        enemy_image[0] = ss.grabImage(8, 1, 32, 32);
        enemy_image[1] = ss.grabImage(9, 1, 32, 32);
        enemy_image[2] = ss.grabImage(10, 1, 32, 32);
